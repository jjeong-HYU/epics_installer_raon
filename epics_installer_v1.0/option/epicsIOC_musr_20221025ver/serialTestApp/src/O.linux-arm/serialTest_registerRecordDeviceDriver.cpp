...
/* Generated from ../O.Common/serialTest.dbd */
...
int serialTest_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/home/ubuntu/epics/serialTest_RAON_ACP40";
...
/* serialTest_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"serialTest_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    iocshSetError(serialTest_registerRecordDeviceDriver(*iocshPpdbbase));
}
