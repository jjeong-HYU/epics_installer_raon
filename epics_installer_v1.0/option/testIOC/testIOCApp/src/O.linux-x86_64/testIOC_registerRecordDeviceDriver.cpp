...
epicsShareExtern dset *pvar_dset_devAaiSoft, *pvar_dset_devAaoSoft,
    ...
    *pvar_dset_devLsiEnviron, *pvar_dset_devtestIOCVersion,
...
static const char * const deviceSupportNames[] = {
    ...
    "asynLoInt64", "devLsiSoft", "devLsiEnviron", "devtestIOCVersion",
...
static const dset * const devsl[] = {
    ...
    pvar_dset_devtestIOCVersion, pvar_dset_asynLsiOctetCmdResponse,
...
epicsShareExtern reg_func pvar_func_QSRVRegistrar,
    ...
    pvar_func_sncExampleRegistrar, pvar_func_syncInitialize,
    pvar_func_testseqRegistrar, pvar_func_tsInitialize,
...
int testIOC_registerRecordDeviceDriver(DBBASE *pbase)
{
    ...
    const char *bldTop = "/home/musr4/epics/testIOC";
...
{
    iocshSetError(testIOC_registerRecordDeviceDriver(*iocshPpdbbase));
}
